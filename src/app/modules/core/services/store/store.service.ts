...
export class StoreService {
  ...
  //     environment.localStorage_keys.favoriteFilmIds
  //   );
  ...
  //       film.isFavorite = this.store.favoriteFilmsIds.some(
  //         (id) => id === film.idIMDB
  //       );
  //       const trailersData = trailers.find(
  //         (trailer) => trailer.idIMDB === film.idIMDB
  //       );
  //       if (trailersData) {
  ...
  //       environment.localStorage_keys.films,
  //       JSON.stringify(this.store.films)
  //     );
  //   }
  //   return films;
  // }
  ...
  //   localStorage.setItem(
  //     environment.localStorage_keys.favoriteFilmIds,
  //     JSON.stringify(this.store.favoriteFilmsIds)
  //   );
  // }
}
